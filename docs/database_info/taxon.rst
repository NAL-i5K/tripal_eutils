...
.. note::
	...
	Developer's note: Taxons are imported using the Tripal core class ``TaxonomyImporter.php``.  Any suggestions or modifications should be made at the `Tripal core repo <https://github.com/tripal/tripal>`_ instead.
